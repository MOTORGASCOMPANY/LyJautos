...
class Empleados extends Component
{
    ...
    public $sort, $direction, $cant, $search, $es = '';
    public $user;
    ...
    protected $rules = [
        ...
        'emp.cont_externo' => 'required',
        'emp.sueldo_neto' => 'required',
        'emp.numero_cuenta' => 'required',
    ];
    ...
    public function render()
    {
        ...
        // Filtro por estado (Planilla o Externo)
        if ($this->es === 'planilla') {
            $query->where(function ($q) {
                $q->whereNull('cont_externo')->orWhere('cont_externo', 0);
            });
        } elseif ($this->es === 'externo') {
            $query->where('cont_externo', 1);
        }
    ...
    // Redireccina boton crear contrato
