...
class ContratosTrabajos extends Component
{
    ...
    public $inspectores;
    public $idUser, $dniEmpleado, $domicilioEmpleado, $fechaInicio, $fechaExpiracion, $cargo, $pago, $celularEmpleado, $correoEmpleado, $cumpleaosEmpleado, $renovacion_id, $fechaIniciodos, $cont_externo;
    public $contrato;
    ...
    public function certificar()
    {
        ...
        $contratoExistente = ContratoTrabajo::where('idUser', $this->idUser)->exists();

        if ($contratoExistente) {
            $this->emit("minAlert", ["titulo" => "¡ERROR!", "mensaje" => "El existe un contrato con este inspector.", "icono" => "error"]);
        ...
        try {
            $nuevoContrato =  ContratoTrabajo::create([
                ...
                'cont_externo' => $this->cont_externo,
            ...
            $this->reset(['idUser', 'dniEmpleado', 'domicilioEmpleado', 'fechaInicio', 'fechaExpiracion', 'cargo', 'pago', 'celularEmpleado', 'correoEmpleado', 'cumpleaosEmpleado', 'cont_externo']);
