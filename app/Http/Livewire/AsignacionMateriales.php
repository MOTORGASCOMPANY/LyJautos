...
class AsignacionMateriales extends Component
{
    ...
    //variables para contado
    public $mostrarPrecio = false; // Controla el estado del checkbox
    public $precio = null; // Valor del precio si se activa el checkbox
    ...
    public function guardar(){
        $this->validate(
            [
                ...
                "precio" => $this->mostrarPrecio ? "required|numeric|min:0" : "nullable", // Validar el precio solo si el checkbox está activo
            ]  
        );
        ...
        // Si el checkbox está activado, guardar los datos en el modelo Contado
        ...
        $this->reset(['articulos', 'inspector', 'mostrarPrecio', 'precio']);
    }
