...
class FormEquipos extends Component
{
    ...
    [
        ...
        "equipo.claseGnv" => "required",
        "equipo.fechaCaducidad" => "nullable|date", //required
        "equipo.fechaCaducidad_aplica" => "nullable", //required
    ];
    ...
    public function salvaTanque()
    {
        $this->validate([
            ...
            "equipo.claseGnv" => "required",
            "equipo.fechaCaducidad" => "nullable|date", //required
            "equipo.fechaCaducidad_aplica" => "nullable"
        ]);

        // Convertir cadena vacía a null
        if ($this->equipo->fechaCaducidad === '') {
            $this->equipo->fechaCaducidad = null;
        }
