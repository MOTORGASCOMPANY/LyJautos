...
class CrearEquipo extends Component
{
    ...
    public $tipoEquipo, $equipoSerie, $equipoMarca, $equipoModelo, $equipoCapacidad, $equipoPeso, $equipoFechaFab, $equipofechaCaducidad, $equipoclaseGnv, $cantEquipos;
    public $equipos = [];

    public $equipofechCaducaAplica = 1; // Por defecto aplica
    ...
    public function salvaTanque()
    {
        ...
        $rules = [
            ...
            "equipoclaseGnv" => "required", //nullable
            //"equipofechaCaducidad" => "nullable" //required
            "equipofechCaducaAplica" => "required|boolean",
        ];

        if ($this->equipofechCaducaAplica) {
            $rules["equipofechaCaducidad"] = "required|date|after:" . $this->equipoFechaFab;
        } else {
            $this->equipofechaCaducidad = null; // ← fuerza a null si no aplica
        }
        ...
        $equipo->claseGnv = $this->equipoclaseGnv;
        $equipo->fechaCaducidad = $this->equipofechaCaducidad;
        $equipo->fechaCaducidad_aplica = $this->equipofechCaducaAplica;
        $equipo->combustible = 'GNV';
        $equipo->save();

        $this->reset(["equipoSerie", "equipoMarca", "equipoModelo", "equipoCapacidad", "tipoEquipo", "equipoFechaFab", "equipoPeso", "equipoclaseGnv", "equipofechaCaducidad", "equipofechCaducaAplica"]);
        $this->open = false;
