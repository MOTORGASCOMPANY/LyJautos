...
class CartaAclaratoria extends Model
{
    ...
    public static function certificarCartAclaratoria(Material $hoja, User $inspector, $titulo, $partida, $placa, $diceData, $debeDecirData, $diceModificacion, $debeDecirModificacion, $parrafo)
    {
        //Condicion para tipo 
        $tipo = 'NE';
