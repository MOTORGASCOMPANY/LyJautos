    ...
    <div class="mt-2 mb-6 px-8 py-2">
        <div class="grid grid-cols-2 gap-4 py-6">
            ...
            <div>
                ...
                <x-jet-input type="text" class="w-full" wire:model="modificacion.direccion" disabled/>
        ...
        <div class="grid grid-cols-2 gap-4 py-6">
            ...
            <div>
                ...
                <x-jet-input type="text" class="w-full" wire:model="modificacion.carga" disabled/>
                <x-jet-input-error for="carga" />
            </div>
        </div>
        <div class="col-span-2">
            <x-jet-label value="Datos a modificar:" />
            <x-textarea class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" wire:model="modificacion.rectificacion" style="height: 200px;" disabled/>
