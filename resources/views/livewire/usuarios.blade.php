        ...
        <x-slot name="content">
            ...
            <div class="mb-4 w-full flex flex-wrap justify-start items-center">
                <div class="w-full ml-0 md:w-1/4 flex justify-start items-center">                                        
                    <x-jet-input type="checkbox" wire:model="usuario.externo" value="1" class="w-4 h-4 text-indigo-600 bg-white border-gray-300 rounded outline-none hover:cursor-pointer focus:ring-indigo-600 focus:ring-1 dark:bg-gray-600 dark:border-gray-500" />
