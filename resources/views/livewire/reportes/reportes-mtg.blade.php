                                            ...
                                            <tbody>
                                                @foreach ($certificacion as $key => $data)
                                                    <tr class="bg-orange-200 hover:bg-orange-300">
                                                        ...
                                                        <td class="whitespace-nowrap border-r px-6 py-3">
                                                            {{-- 
                                                            @if ($data['servicio'] === 'Chip por deterioro' && $data['tipo_modelo'] === App\Models\Certificacion::class)
                                                                @if (is_null($data['descripcion']))
                                                                    {{ Str::afterLast($data['ubi_hoja'], '/') ?? 'N.A' }}
                                                                @else
                                                                    {{ Str::afterLast($data['descripcion'], '/') ?? 'N.A' }}
                                                                @endif
                                                            @else
                                                        ...
                                                        <td class="whitespace-nowrap border-r px-6 py-3">
                                                            @if ($data['pagado'] == 0)
                                                                Sin cobrar
                                                            @elseif ($data['servicio'] == 'Activación de chip (Anual)')
                                                                Cert. Pendiente
                                                            @elseif ($data['pagado'] == 2)
                                                                Cobrado                                                    
                                                            @endif
                                                        </td>
                                                        <td class="whitespace-nowrap border-r px-6 py-3">
