                                        ...
                                        <table class="min-w-full border text-center text-sm font-light rounded-xl overflow-hidden">
                                            <thead class="font-medium dark:border-neutral-500">
                                                <tr class="bg-indigo-200">
                                                    ...
                                                    <th scope="col"
                                                        class="border-r px-6 py-4 hidden">
                                                        MODELO
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                    ...
                                                    <tr class="bg-orange-200 hover:bg-orange-300">
                                                        ...
                                                        <td class="whitespace-nowrap border-r px-6 py-3">
                                                            {{--
                                                                    ...
                                                                    (($data['externo'] == 1 && $data['estado'] == 2 && $data['tipo_modelo'] == 'App\Models\Certificacion') ? ', ' : null) .
                                                                    (($data['estado'] == 2 && $data['tipo_modelo'] == 'App\Models\Certificacion') ? 'Anulado' : null) .
                                                                    (isset($data['solo_en_certificacion']) && $data['solo_en_certificacion'] ? 
                                                                        (($data['externo'] || ($data['estado'] == 2 && $data['tipo_modelo'] == 'App\Models\Certificacion')) ? ', ' : '') . 'MTG' : null)
                                                                --}}
                                                            {{ isset($data['placaantigua']) && $data['placaantigua'] == 1
                                                                ? 'Placa antigua'
                                                                : ($data['externo'] == 1 ? 'Externo' : null) .
                                                                    ...
                                                                    ($data['estado'] == 2 && $data['tipo_modelo'] == 'App\Models\Certificacion' ? 'Anulado' : null) .
                                                                    (isset($data['solo_en_certificacion']) && $data['solo_en_certificacion']
                                                                        ? ($data['externo'] || ($data['estado'] == 2 && $data['tipo_modelo'] == 'App\Models\Certificacion')
                                                                                ? ', '
                                                                                : '') . 'MTG'
                                                                        : null) }}
                                                        ...
                                                        <td class="whitespace-nowrap border-r px-6 py-3 hidden">
                                                ...
                                                <tr class="bg-green-200">
                                                    <td colspan="9"
                                                        class="border-r px-6 py-3 font-bold text-right">
                                                        Total:
                                                    </td>
