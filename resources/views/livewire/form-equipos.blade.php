                                    ...
                                    <div class="block  w-5/6 bg-white border border-black p-2 rounded-lg shadow-lg m-auto mb-4">
                                        <div class="flex flex-row w-full">
                                            <div class="block bg w-5/6">
                                                ...
                                                <p>Clase Gnv Tipo: <strong>{{ $e['claseGnv'] }}</strong></p>
                                                <p>Fecha fin de vida:
                                                    {{--<strong>{{ $e->fechaCaducidad ? date('d/m/Y', strtotime($e->fechaCaducidad)) : 'NE' }}</strong>--}}
                                                    @if (is_null($e->fechaCaducidad) && $e->fechaCaducidad_aplica == 0)
                                                        <strong>NE</strong>
                                                    @elseif (!is_null($e->fechaCaducidad))
                                                        <strong>{{ date('d/m/Y', strtotime($e->fechaCaducidad)) }}</strong>
                                                    @else                                                       
                                                    @endif                                                    
                                                </p>
                                            </div>
