  ...
  <div class="container mx-auto py-12">
   ...
   <x-jet-dialog-modal wire:model="editando" wire:loading.attr="disabled" >
    ...
    <x-slot name="content">
        ...
        <div class="mb-4">
          <x-jet-label value="N° Autorizacion GNV:" />
          <x-jet-input wire:model="taller.autorizacion" type="text" class="w-full" />
          <x-jet-input-error for="taller.autorizacion" />
        </div>
        @if ($taller && $taller->autorizado_glp == 1)
            <div class="mb-4">
                <x-jet-label value="N° Autorizacion GLP:" />
                <x-jet-input wire:model="taller.autorizacionGlp" type="text" class="w-full" />
                <x-jet-input-error for="taller.autorizacionGlp" />
            </div>
        @endif     
