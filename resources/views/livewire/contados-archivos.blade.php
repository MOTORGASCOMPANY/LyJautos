<div class="space-y-4">
    @if ($contado->contadoarchivo->count())
        @foreach ($contado->contadoarchivo as $doc)
            <div
                ...
                <div class="w-full bg-white">
                    <div class="flex flex-row w-full divide-x divide-gray-400/20">
                        ...
                        <div class="bg-indigo-100/30 w-1/2 md:w-1/3 flex justify-center space-x-2 items-center px-3">
                            ...
                            --}}
                            <a href="{{ $doc->migrado == 0 ? Storage::url($doc->ruta) : $doc->url_temporal }}"
            ...
            Livewire.on('deleteDocumento', documentoId => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('contados-archivos', 'eliminar', documentoId);
