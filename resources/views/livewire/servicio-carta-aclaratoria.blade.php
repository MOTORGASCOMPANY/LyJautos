    ...
    @if ($estado)
        @switch($estado)
            @case('esperando')
                ...
                <div class="max-w-5xl m-auto bg-white rounded-lg shadow-md">
                    <div class="flex items-center justify-between bg-gray-400 py-4 px-6 rounded-t-lg">
                        <div class="flex items-center">
                            <span class="text-lg font-semibold text-white dark:text-gray-400">Datos de la Carta
                                Aclaratoria</span>
                        </div>
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex items-center">
                                <x-jet-input type="checkbox" wire:model="parrafo"
                                ...
                                <x-jet-label value="Párr" class="py-2 ml-2 text-sm font-medium text-gray-900 select-none hover:cursor-pointer" />
                                <x-jet-input-error for="parrafo" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white mb-6 px-8 py-2 rounded-lg">
                        ...
                        <!-- Condicional basado en el checkbox -->
                        @if ($parrafo)
                            <div class="mt-2">
                                <textarea
                                    class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                    wire:model="diceModificacion" placeholder="Parrafo..." style="height: 75px;"></textarea>
                        ...
                        @else
                            <div>
                                ...
                                <div class="mt-2">
                                    <textarea
                                        class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                        wire:model="debeDecirModificacion" placeholder="Parrafo..." style="height: 75px;"></textarea>
