            ...
            <x-custom-table>
                ...
                <x-slot name="btnAgregar" class="mt-6 ">
                    <div class="flex flex-col md:flex-row md:items-center md:space-x-4 w-full">
                        <!-- SELECT ESTADO -->
                        <div class="flex items-center bg-white p-2 rounded-md mb-2 md:mb-0">
                            <span class="text-sm">Estado:</span>
                            <select wire:model="es" class="bg-gray-50 mx-2 border-indigo-500 rounded-md outline-none w-full md:w-auto">
                                <option value="">SELECCIONE</option>
                                <option value="1">En envio</option>
                                            ...
                                            @foreach ($salidas as $item)
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                        <div class="flex items-center">
                                                            <p class="whitespace-no-wrap">
                                                                {{ $item->usuarioAsignado->name ?? null }}
                                                            </p>
                                                        </div>
                                                    </td>
                                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
