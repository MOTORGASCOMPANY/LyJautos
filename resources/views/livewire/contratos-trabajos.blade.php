                ...
                <div class="grid grid-cols-1"> {{-- md:grid-cols-2 --}}
                    ...
                    <div class="mb-6 px-8 py-2">
                        <div class="flex items-center justify-between bg-gray-400 py-4 px-6 rounded-t-lg">
                            <span class="text-lg font-semibold text-white dark:text-gray-200">Datos del Empleado</span>
                        </div>
                        <div class="mb-6 px-8 py-2">
                            ...
                            <div class="grid grid-cols-2 gap-4 py-2">
                                ...
                                <div class="flex items-center my-6">
                                    <input type="checkbox" wire:model="cont_externo"
                                        class="mr-2 text-indigo-500 focus:ring-indigo-400 focus:ring-opacity-25 border-gray-300 rounded">
                                    <label for="cont_externo" class="text-gray-700">¿Contrato Externo?</label>
                                </div>
                            </div>
                        </div>
                    </div>
