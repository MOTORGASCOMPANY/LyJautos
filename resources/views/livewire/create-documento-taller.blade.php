        ...
        <x-slot name="content">
            ...
            @if ($combustibleSeleccionado)
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="date" wire:model="fechaInicial" placeholder="Fecha de inicio"
                        class="bg-gray-50 border-indigo-500 rounded-md outline-none w-full" />
                ...
                <div class="mb-4">
                    ...
                    <x-date-picker wire:model="fechaCaducidad" placeholder="Fecha de Fin"
                        class="bg-gray-50 border-indigo-500 rounded-md outline-none w-full" />--}}
                    <x-jet-input type="date" wire:model="fechaCaducidad" placeholder="Fecha de Fin"
                        class="bg-gray-50 border-indigo-500 rounded-md outline-none w-full" />
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="file" id="documento" wire:model="documento" />
