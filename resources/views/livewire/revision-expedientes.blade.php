                                        ...
                                        @foreach ($expedientes as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                    <div class="flex items-center">
                                                        <p class="text-gray-900 whitespace-no-wrap">
                                                            {{-- $item->servicio->tipoServicio->descripcion ?? null --}}
                                                            @if (optional($item->servicio->tipoServicio)->id == 5)
                                                                {{--@if ($cert && optional($cert->modificacionDetalle)->tipo_modificacion === 'motor')--}}
                                                                @if ($cert && $cert->descripcion === 'Modificación Motor')
                                                                    Modificación Motor
                                                                @else
                                                                    Modificación
                                                                @endif
        ...
        <x-jet-dialog-modal wire:model="editando" wire:loading.attr="disabled" wire:target="deleteFile">
            ...
            <x-slot name="content">
                ...
                @if (count($files))
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex w-56 flex-col items-center">
                                                        <div class="rounded bg-gray-900 p-2 text-xs text-center shadow-lg">
                                                            Información:
                                                            <p class="text-xs">Tipo: {{ $fil->TipoImagen->descripcion ?? 'NA' }}</p>
                    ...
                    @hasrole('administrador|supervisor|Administrador del sistema')
