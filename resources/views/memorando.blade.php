...
<body>
    ...
    <main>
        ...
        <div>
            ...
            <p>Señor {{ $idUser }}, por medio del presente me dirijo a usted para hacer de su conocimiento que {!! nl2br(e($motivo ?? null)) !!}
            </p>
            ...
            <tr>
                <td style="text-align: center;">
                    <p style="text-align: center;">
                        @if ($remitente == 'LOPEZ HENRIQUEZ SPASOJE BRATZO' || $remitente == 'MOTORGAS COMPANY')
